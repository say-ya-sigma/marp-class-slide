...
* Multicsプロジェクトはあまり上手く行かなかった
* UNIXが他の様々なプロジェクトに流用された
* 送料・メディア代(今でいうUSB代)だけで使えた
* 独自に研究・開発・変更ができた
...
* フィンランドの大学生Linus Torvalds
* 1991年「僕は今、(UNIX に似た) OS を作っている。」
* 当時のUNIXのイメージ
  * 高いライセンス使用料
  * 企業や大学で使われる
* UNIX互換OSとして立派に動作するまでになった
...
# GNUプロジェクトについて補足
* GNUライセンスのツール群など
* 通常Linuxと組み合わせて使われ「GNU/Linux」と呼ばれる
* その他のものと組み合わせるパターン
  * GNU/Hurd
  * GNU/kFreeBSD
